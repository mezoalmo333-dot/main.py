...
def run_bot_forever():
    ...
    # تشغيل polling بطريقة واضحة ومستقرة على Android/Pydroid.
    # إذا كان هناك تشغيل آخر بنفس التوكن سيظهر السبب 409 بدل رسالة مبهمة.
    try:
        bot.remove_webhook()
    ...
    while True:
        try:
            ...
            print("[Polling] polling() exited; restarting in 3 seconds...")
            time.sleep(3)
            ...
            if (
                ...
                print(
                    "[Polling 409] يوجد تشغيل آخر لهذا البوت بنفس التوكن. "
                    "أغلق النسخة الأخرى ثم أعد التشغيل."
                )
                time.sleep(8)
            else:
                time.sleep(3)
